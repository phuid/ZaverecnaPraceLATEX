...
\usepackage[a4paper,top=2.5cm,bottom=3cm,left=3cm,right=2.5cm]{geometry}
...
\pagestyle{empty} %instead of \thispagestyle because tableofcontents could be longer than one page 
...
\begin{figure}
      \centering
      \includegraphics[width=0.5\textwidth]{The_Bug_Peek.jpg}
...
\begin{figure}
      \centering
      \includegraphics[width=0.5\textwidth]{Alcedo_atthis_-_Riserve_naturali_e_aree_contigue_della_fascia_fluviale_del_Po.jpg}
